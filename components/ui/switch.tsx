...
>(({ className, variant = 'default', ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      variant === 'danger'
        ? 'data-[state=checked]:bg-red-600 data-[state=unchecked]:bg-slate-200 focus-visible:ring-red-500'
        : 'data-[state=checked]:bg-emerald-600 data-[state=unchecked]:bg-slate-200 focus-visible:ring-emerald-500',
      className,
    )}
    {...props}
    ref={ref}
