        ...
        <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 shadow-sm">
          <div className="px-3 sm:px-4 lg:px-6 py-2.5 sm:py-3 flex items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-0.5 sm:gap-1.5 shrink-0 min-w-0">
              ...
              {/* Account (moved from sidebar bottom) */}
              <div className="flex items-center gap-2 pl-1 sm:pl-2 sm:pr-1 py-1 rounded-xl border border-slate-200/80 bg-slate-50/80 shrink-0 min-h-[40px] max-w-[14rem] sm:max-w-[16rem]">
                ...
                <button
                  ...
                  className="p-1.5 hover:bg-slate-200/80 rounded-lg transition-colors text-slate-500 hover:text-slate-800 shrink-0"
                  title="Sign out"
                  aria-label="Sign out"
                >
                  <LogOut size={16} />
