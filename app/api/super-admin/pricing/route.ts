...
export async function POST(request: NextRequest) {
  try {
    ...
    const ruleData: any = {
      ...
      ...(charsPerBlock !== undefined && { charsPerBlock }),
      ...(pricePerBlock !== undefined && { pricePerBlock }),
      ...(ucs2CharsPerBlock !== undefined && { ucs2CharsPerBlock }),
      ...(ucs2PricePerBlock !== undefined && { ucs2PricePerBlock }),
      ...(pricePerCharacter !== undefined && { pricePerCharacter }),
      ...(ucs2PricePerCharacter !== undefined && { ucs2PricePerCharacter }),
      ...(samePriceForEncodings !== undefined && { samePriceForEncodings }),
      ...(roundPartialBlocks !== undefined && { roundPartialBlocks }),
      ...(minimumChargePerMessage !== undefined && { minimumChargePerMessage }),
      ...(tiers && { tiers }),
